                    ...
                    <div class="panel-body">
                        <div class="row" style="margin-bottom:40px">
                            <form method="post" action="/admin/product/store" enctype="multipart/form-data">
                                <div class="col-md-8">
                                    {{-- <div class="alert alert-danger">asdasda</div> --}}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="info" value="{{old('info')}}" style="width: 100%;height: 100px;"></textarea>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Miêu tả</label>
                                    <textarea id="editor" name="describer" value="{{old('describer')}}" style="width: 100%;height: 100px;"></textarea>
                                </div>
